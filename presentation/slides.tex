...
\begin{frame}{Pipeline}
	\begin{center}
		...
		\smartdiagram[flow diagram: horizontal]{Outliers removal, Daily Resample, Removing seasonal component, Transformation (with Box-Cox test), Scale between 0 and 1}
	\end{center}
\end{frame}
